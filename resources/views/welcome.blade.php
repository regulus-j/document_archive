    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Choose the plan that fits your
                    needs.</p>
                <div class="flex mx-auto border-2 border-blue-500 rounded overflow-hidden mt-6">
                    ...
                    <button class="py-1 px-4 focus:outline-none">Yearly</button>
                </div>
            </div>
                ...
                <div class="p-4 w-full md:w-1/3">
                    <div class="h-full p-6 rounded-lg border-2 border-blue-500 flex flex-col relative overflow-hidden">
                        ...
                        <p class="flex items-center text-gray-600 mb-2">
                            <span
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="h-10 w-9 flex-none text-blue-600">
                        ...
                        <p class="flex items-center text-gray-600 mb-2">
                            ...
                            </span> Basic role & permission settings
                        </p>

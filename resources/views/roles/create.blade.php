    ...
    <div class="min-h-screen bg-gray-100 p-4 md:p-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-700">Role Information</h2>
            </div>
            ...
            <form method="POST" action="{{ route('roles.store') }}" class="p-6">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button type="button" id="deselectAll"
                                    class="text-xs text-blue-600 hover:text-blue-800">Deselect All</button>
                            </div>
                        </div>
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 p-4">
                                    @foreach($permission as $value)
                                        <div
                                            class="bg-white p-3 rounded-md border border-gray-200 hover:border-blue-300 transition-colors">
                ...
                <div class="mt-6 flex items-center justify-end">
                    <a href="{{ route('roles.index') }}" class="text-sm text-gray-700 hover:text-gray-500 mr-4">Cancel</a>
                    <button type="submit"

                ...
                <div class="relative flex flex-col rounded-2xl border border-gray-200 p-8 shadow-sm">
                    <div>
                        ...
                        <div class="mt-4 flex items-baseline">
                            <span class="text-5xl font-bold tracking-tight text-gray-900">P0.00</span>
                            <span class="ml-1 text-sm font-semibold text-gray-500">forever</span>
                        </div>
                    </div>
                    ...
                    <p class="mt-6 text-center text-sm text-gray-500">Basic features with limited functionality.</p>
                </div>

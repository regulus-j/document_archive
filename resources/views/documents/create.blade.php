                    ...
                    <div class="p-6 sm:p-10">
                        ...
                        @if ($errors->any())
                            <div class="rounded-md bg-red-50 p-4 mb-6">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-red-800">There were some problems with your input.
                                        </h3>
                        ...
                        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label for="office_id" class="block text-sm font-medium text-gray-700">Select
                                        Office</label>
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600">
                                                <label for="main-document"
                                                    ...
                                                    <input id="main-document" name="upload" type="file"

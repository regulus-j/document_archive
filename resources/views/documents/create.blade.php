                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        {{-- <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="tracking_number" id="tracking_number"
                                    ...
                                    placeholder="2021-1020-2890-0049" required readonly value="{{ $tracking }}">
                        ...
                        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="tracking_number" id="tracking_number" value="{{ $tracking }}"
                                    class="bg-gray-50 block w-full pl-10 rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    readonly>
                            </div>
                            <p class="mt-2 text-sm text-gray-500">Ensure the tracking number matches the physical
                                document.</p>
                                ...
                                <div class="sm:col-span-2">
                                    <label for="upload" class="block text-sm font-medium text-gray-700">Upload
                                        Document</label>
                                    <div

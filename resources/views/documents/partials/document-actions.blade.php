<div class="relative" x-data="{ open: false }">
    ...
    @endcan
                ...
                @if (auth()->user()->can('delete', $document))
                    <!-- Delete Action -->
                    <button type="button"
                        wire:click="confirmDocumentDeletion({{ $document->id }})"
                        class="group inline-flex items-center p-1.5 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors duration-150"

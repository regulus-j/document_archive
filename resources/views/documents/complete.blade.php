                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-4 px-6">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            ...
                                            @elseif($document->status->status == 'complete') bg-green-100 text-blue-800
                                            @elseif($document->status->status == 'retracted') bg-red-100 text-blue-800
                                            @endif">
                                    ...
                                    <td class="py-4 px-6">
                                        @switch($document->status->status)
                                            @case('released')
                                                ...
                                                <a href="{{ route('documents.changeStatus', ['id' => $document->id, 'status' => 'complete']) }}" class="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                                    Tag as Complete
                                                </a>
                                                @break
                                            @case('complete')
                                                <a href="{{ route('documents.changeStatus', ['id' => $document->id, 'status' => 'retracted']) }}" class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                                    Retract
                                                </a>
                                                @break
                                                    Retract
                                                ...
                                                @break
                                            @case('retracted')
                                                <a href="{{ route('documents.changeStatus', ['id' => $document->id, 'status' => 'received']) }}" class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                                    Return
                                                </a>
